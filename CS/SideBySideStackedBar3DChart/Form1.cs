...
namespace SideBySideStackedBar3DChart {
    public partial class Form1 : Form {
        ...
        private void Form1_Load(object sender, EventArgs e) {
            ...
            Series series1 = new Series("Series 1", ViewType.SideBySideStackedBar3D);
            Series series2 = new Series("Series 2", ViewType.SideBySideStackedBar3D);
            Series series3 = new Series("Series 3", ViewType.SideBySideStackedBar3D);
            Series series4 = new Series("Series 4", ViewType.SideBySideStackedBar3D);
